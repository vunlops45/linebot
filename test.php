...
$response = file_get_contents('https://covid19.th-stat.com/json/covid19v2/getSumCases.json', true);
//$response = file_get_contents('https://www.thaigold.info/RealTimeDataV2/gtdata_.txt');
echo $response;
